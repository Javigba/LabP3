/**
 * @file TOPTW.java
 * @brief Contiene la implementación del problema TOPTW y sus funciones asociadas.
 */
package top;
...
/**
 * @class TOPTW
 * @brief Implementación del problema de rutas de vehículos con ventana de tiempo (TOPTW).
 */
public class TOPTW {
    private int nodes;
    private double[] x;
