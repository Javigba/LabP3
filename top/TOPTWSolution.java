 ...
 * @brief Contiene la implementación de la clase TOPTWSolution.
 */
package top;
...
/**
 * @class TOPTWSolution
 * @brief Representa una solución al problema TOPTW.
 */
public class TOPTWSolution {
    ...
    /**
     * @brief Constructor de TOPTWSolution.
     * @param problem El problema asociado a la solución.
     */
